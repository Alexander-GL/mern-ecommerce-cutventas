...
import { getCategories, isAuthenticated, createFashionWoman } from './apiCore';
import Jumbotron from 'react-bootstrap/Jumbotron';
import model_product from '../images/model_product.png';

const AddFashionWoman = () => {
    ...
    const showError = () => (
      ...
      const showSuccess = () => (
        <div className='alert alert-info' style={{ display: createdFashionWoman ? '' : 'none' }}>  
        <h5>{`${createdFashionWoman} ha sido creado correctamente`}</h5>
        </div>
      )
      ...
      const clickSubmit = event => {
        ...
        createFashionWoman(user._id, token, formData).then(data => {
          if (data.error) {
            setValues({ ...values, error: data.error })
          } else {
            setValues({
        ...
        <div className="container">
          <div className="col-lg-8 col-md-8 col-sm-12">
            ...
            <h5>Elige la imagen de tu producto...</h5>
              ...
              <button className='btn btn-success col-12'>Agregar producto</button>
            </form>
          </div>
          </div>
      )     
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css"
            ...
            <div className="container">
              ...
              <div className="row">
                ...
                <Jumbotron>
                  <h3 className="col-12">Ropa de Dama</h3>
                    <div className="m-1">
                      {showLoading()}
                      {showSuccess()}
                      {showError()}
...
export default AddFashionWoman;