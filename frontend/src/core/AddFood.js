...
import { getCategories, isAuthenticated, createFood } from './apiCore';
...
const AddFood = () => {
    ...
    const showError = () => (
      ...
      const showSuccess = () => (
        <div className='alert alert-info' style={{ display: createdFood ? '' : 'none' }}>  
        <h5>{`${createdFood} ha sido creado correctamente`}</h5>
        </div>
      )
        ...
        <div className="container">
          <div className="col-lg-8 col-md-8 col-sm-12">
            ...
            <h5>Elige la imagen de tu producto...</h5>
              ...
              <div className='form-group'>
                <label className='text-muted'>Combos</label>
                <input
                  onChange={handleChange('combos')}
                  type='text'
                  className='form-control'
                  value={combos}
                  required autoFocus
    ...
    return (
      <div>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css"
            ...
            <Navigation2 />
            <div className="container">
                  <img className="flayer-product-food" src={model_product} alt="Model Product" />
              <div className="row">
                <div className="col-md-12">
                <Jumbotron>
                  <h3 className="col-12">Alimentos & Bebidas</h3>
                    <div className="m-1">
                      {showLoading()}
                      {showSuccess()}
                      {showError()}
